...
urlpatterns = [
    ...
    path('ajax/cve/scan/<int:system_id>/', main_views.ajax_scan_cve_specific_system, name='scan_cve'),
    path('ajax/all/cve/scan/', main_views.ajax_scan_cve_all_systems, name='scan_cve_all_systems'),
